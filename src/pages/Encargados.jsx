            ...
            {['admin', 'usuario'].map((id) => (
              <div key={id} className="bg-white rounded-[2.5rem] p-8 border border-emerald-100 shadow-sm hover:shadow-xl transition-all">
                ...
                <div className="flex gap-3 mt-8">
                  <button onClick={() => setGuiaAbierta(id)} className="flex-1 py-4 bg-emerald-600 text-white rounded-2xl font-black text-[10px] uppercase hover:bg-emerald-600 transition-colors shadow-md">Leer Ahora</button>
